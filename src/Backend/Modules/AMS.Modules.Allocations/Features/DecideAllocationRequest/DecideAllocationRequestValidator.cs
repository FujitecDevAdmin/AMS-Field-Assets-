...
/// </remarks>
public sealed class DecideAllocationRequestValidator : AbstractValidator<DecideAllocationRequestRequest>
{
    public DecideAllocationRequestValidator()
    {
        RuleFor(x => x.DecisionRemarks).MaximumLength(500);
    }
}
