...
namespace AMS.Modules.Verification.Persistence;

/// <summary>
/// The Verification module's context. Owns schema <c>[Verification]</c> and nothing
...
public sealed class VerificationDbContext(DbContextOptions<VerificationDbContext> options) : DbContext(options)
{
    ...
    public const string SchemaName = "Verification";

    public DbSet<PhysicalVerification> PhysicalVerifications => Set<PhysicalVerification>();
