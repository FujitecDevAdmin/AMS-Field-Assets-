...
public static class DecideApprovalEndpoint
{
    public static void Map(RouteGroupBuilder group)
    {
        ...
        group.MapPost("/approvals/participants/{participantId:long}/decision", async (
                long participantId,
                DecideApprovalRequest request,
                IDispatcher dispatcher,
                CancellationToken ct) =>
            {
                var message = DecideApprovalMapper.ToCommand(request, participantId);
            ...
            .Produces<DecideApprovalResponse>(StatusCodes.Status200OK)
