...
/// </summary>
public static class UpdateServiceTemplateEndpoint
{
    public static void Map(RouteGroupBuilder group)
    {
        ...
        group.MapPut("/templates/{id:int}", async (
            ...
            {
                var message = UpdateServiceTemplateMapper.ToCommand(request, id);
            ...
            .Produces<UpdateServiceTemplateResponse>(StatusCodes.Status200OK)
