...
/// </remarks>
public sealed class RegenerateRecoveryCodesValidator : AbstractValidator<RegenerateRecoveryCodesRequest>
{
    public RegenerateRecoveryCodesValidator()
    {
        // Re-prove the second factor first: regenerating from a hijacked session would lock the real owner out permanently.
