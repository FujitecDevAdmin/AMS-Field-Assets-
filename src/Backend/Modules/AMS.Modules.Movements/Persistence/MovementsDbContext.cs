...
/// <summary>
/// The Movements module's context. Owns schema <c>[Movements]</c> and nothing
/// else (docs/01 §2 rule 1).
/// </summary>
public sealed class MovementsDbContext(DbContextOptions<MovementsDbContext> options) : DbContext(options)
{
    /// <summary>The schema this module owns, and its migrations-history schema.</summary>
    public const string SchemaName = "Movements";
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.HasSequence<long>("MovementBatchNumberSequence", SchemaName)
            .StartsAt(1)
            .IncrementsBy(1);
