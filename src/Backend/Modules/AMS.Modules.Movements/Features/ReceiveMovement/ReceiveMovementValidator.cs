...
/// </remarks>
public sealed class ReceiveMovementValidator : AbstractValidator<ReceiveMovementRequest>
{
    public ReceiveMovementValidator()
    {
        RuleFor(x => x.ReceiptRemarks).MaximumLength(500);
    }
}
