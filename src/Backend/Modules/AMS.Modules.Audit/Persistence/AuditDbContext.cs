...
/// <summary>
/// The Audit module's context. Owns schema <c>[Audit]</c> and nothing
...
public sealed class AuditDbContext(DbContextOptions<AuditDbContext> options) : DbContext(options)
{
    ...
    public DbSet<AssetFieldAudit> AssetFieldAudits => Set<AssetFieldAudit>();

    public DbSet<ScheduledFieldChange> ScheduledFieldChanges => Set<ScheduledFieldChange>();
